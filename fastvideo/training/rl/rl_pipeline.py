...
class RLPipeline(TrainingPipeline):
    ...
    def initialize_training_pipeline(self, training_args: TrainingArgs):
        ...
        # Initialize reward models (not needed for DPO)
        ...
        if self.algorithm.requires_value_model:
            ...
            logger.info("Algorithm %s does not require value model", self.algorithm.name)
    ...
    def compute_advantages(self, training_batch: TrainingBatch) -> TrainingBatch:
        ...
        Delegates to the algorithm for advantage computation, allowing
        different algorithms to use different methods (GAE, simple TD, etc.)
        ...
        """
        logger.debug("Computing advantages using %s algorithm", self.algorithm.name)
